...
for bits in range(int(ceil(log(20)/log(2))+4),  int(ceil(log(20)/log(2))-1), -1):
	...
	s.add(
	Sum([ ZeroExt(int(ceil(log(bits)/log(2))+1), Extract(i,i,(st_st3_n ^ st_st7))) for i in range(bits) ]) ==
	Sum([ ZeroExt(int(ceil(log(bits)/log(2))+1), Extract(i,i,(st_st9_n ^ st_st4))) for i in range(bits) ])
	)
	s.add(
	...
	s.add(
	Sum([ ZeroExt(int(ceil(log(bits)/log(2))+1), Extract(i,i,(st_st7_n ^ st_st4))) for i in range(bits) ]) ==
	Sum([ ZeroExt(int(ceil(log(bits)/log(2))+1), Extract(i,i,(st_st9_n ^ st_st4))) for i in range(bits) ])
	)
	s.add(
