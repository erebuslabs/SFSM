from z3 import *
from math import *
for bits in range(int(ceil(log(14)/log(2))+4),  int(ceil(log(14)/log(2))-1), -1):
	st_st0, st_st0_n, st_st1, st_st4, st_st1_n, st_st2, st_st2_n, st_st3, st_st3_n, st_st4_n, st_st5, st_st5_n, st_st6, st_st6_n = BitVecs('st_st0 st_st0_n st_st1 st_st4 st_st1_n st_st2 st_st2_n st_st3 st_st3_n st_st4_n st_st5 st_st5_n st_st6 st_st6_n',bits)

	s = Solver();
	s.set("timeout", 30000)
	s.add(Distinct(st_st0,st_st0_n,st_st1,st_st4,st_st1_n,st_st2,st_st2_n,st_st3,st_st3_n,st_st4_n,st_st5,st_st5_n,st_st6,st_st6_n))
