from z3 import *
from math import *
for bits in range(int(ceil(log(9)/log(2))+4),  int(ceil(log(9)/log(2))-1), -1):
	st_1, st_0, st_7, st_5, st_4, st_2, st_3, st_6, st_8 = BitVecs('st_1 st_0 st_7 st_5 st_4 st_2 st_3 st_6 st_8',bits)

	s = Solver();
	s.set("timeout", 30000)
	s.add(Distinct(st_1,st_0,st_7,st_5,st_4,st_2,st_3,st_6,st_8))
