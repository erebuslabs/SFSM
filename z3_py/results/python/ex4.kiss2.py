...
for bits in range(int(ceil(log(14)/log(2))+4),  int(ceil(log(14)/log(2))-1), -1):
	st_1, st_3, st_2, st_5, st_7, st_11, st_12, st_8, st_4, st_13, st_14, st_6, st_9, st_10 = BitVecs('st_1 st_3 st_2 st_5 st_7 st_11 st_12 st_8 st_4 st_13 st_14 st_6 st_9 st_10',bits)

	s = Solver();
	s.set("timeout", 30000)
	s.add(Distinct(st_1,st_3,st_2,st_5,st_7,st_11,st_12,st_8,st_4,st_13,st_14,st_6,st_9,st_10))
