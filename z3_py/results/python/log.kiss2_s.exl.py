...
for bits in range(int(ceil(log(24)/log(2))+4),  int(ceil(log(24)/log(2))-1), -1):
	st_1, st_2, st_1_n, st_3, st_4, st_3_n, st_5, st_4_n, st_6, st_5_n, st_7, st_6_n, st_8, st_9, st_12, st_10, st_11, st_13, st_14, st_13_n, st_15, st_14_n, st_16, st_0 = BitVecs('st_1 st_2 st_1_n st_3 st_4 st_3_n st_5 st_4_n st_6 st_5_n st_7 st_6_n st_8 st_9 st_12 st_10 st_11 st_13 st_14 st_13_n st_15 st_14_n st_16 st_0',bits)

	s = Solver();
	s.set("timeout", 30000)
	s.add(Distinct(st_1,st_2,st_1_n,st_3,st_4,st_3_n,st_5,st_4_n,st_6,st_5_n,st_7,st_6_n,st_8,st_9,st_12,st_10,st_11,st_13,st_14,st_13_n,st_15,st_14_n,st_16,st_0))
	...
	s.add(
	Sum([ ZeroExt(int(ceil(log(bits)/log(2))+1), Extract(i,i,(st_6_n ^ st_7))) for i in range(bits) ]) ==
	Sum([ ZeroExt(int(ceil(log(bits)/log(2))+1), Extract(i,i,(st_0 ^ st_1))) for i in range(bits) ])
	)
	s.add(
	Sum([ ZeroExt(int(ceil(log(bits)/log(2))+1), Extract(i,i,st_6_n)) for i in range(bits) ]) ==
