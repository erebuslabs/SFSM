...
for bits in range(int(ceil(log(10)/log(2))+4),  int(ceil(log(10)/log(2))-1), -1):
	st_1, st_2, st_4, st_3, st_0, st_7, st_8, st_6, st_5, st_9 = BitVecs('st_1 st_2 st_4 st_3 st_0 st_7 st_8 st_6 st_5 st_9',bits)

	s = Solver();
	s.set("timeout", 30000)
	s.add(Distinct(st_1,st_2,st_4,st_3,st_0,st_7,st_8,st_6,st_5,st_9))
