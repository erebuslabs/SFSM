...
for bits in range(int(ceil(log(7)/log(2))+4),  int(ceil(log(7)/log(2))-1), -1):
	st_st0, st_st1, st_st4, st_st2, st_st3, st_st5, st_st6 = BitVecs('st_st0 st_st1 st_st4 st_st2 st_st3 st_st5 st_st6',bits)

	s = Solver();
	s.set("timeout", 30000)
	s.add(Distinct(st_st0,st_st1,st_st4,st_st2,st_st3,st_st5,st_st6))
