...
for bits in range(int(ceil(log(16)/log(2))+4),  int(ceil(log(16)/log(2))-1), -1):
	st_st0, st_st1, st_st9, st_st6, st_st8, st_st2, st_st5, st_st3, st_st4, st_st7, st_st10, st_st11, st_st12, st_st13, st_st14, st_st15 = BitVecs('st_st0 st_st1 st_st9 st_st6 st_st8 st_st2 st_st5 st_st3 st_st4 st_st7 st_st10 st_st11 st_st12 st_st13 st_st14 st_st15',bits)

	s = Solver();
	s.set("timeout", 30000)
	s.add(Distinct(st_st0,st_st1,st_st9,st_st6,st_st8,st_st2,st_st5,st_st3,st_st4,st_st7,st_st10,st_st11,st_st12,st_st13,st_st14,st_st15))
